    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea placeholder="Enter billing address" className="h-20" />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button onClick={addNewItem} size="sm" className="bg-pink-600 hover:bg-pink-700">
            <Plus className="w-4 h-4 mr-1" />
            Add Item
          </Button>
        </CardHeader>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label>Notes</Label>
                <Textarea placeholder="Add any notes..." className="h-20" />
              </div>
              <div className="space-y-2">
                <Label>Terms & Conditions</Label>
                <Textarea placeholder="Enter terms and conditions..." className="h-20" />
              </div>
              <div className="space-y-2">
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Button className="bg-pink-600 hover:bg-pink-700" onClick={handleGeneratePDF}>
